...
def glan_instruction_generation(args):
    ...
    filename = f"GLAN_Questions_{LANGUAGE}_{num_questions}_Samples_{UUID}.jsonl"
    ...
    filename = f"GLAN_Instructions_{LANGUAGE}_{num_instructions}_Samples_{UUID}.jsonl"
